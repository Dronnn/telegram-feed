...
- При скролле вверх старые сообщения догружаются только после явного пользовательского жеста вверх и только когда скрытый сверху буфер уже почти исчерпан; догрузка идёт небольшими порциями и не должна визуально сдвигать уже видимое сообщение.
