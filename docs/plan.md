...
- При обычном окончании скролла лента не должна сама перепривязываться к другому сообщению или подскакивать.
- При скролле вверх старые сообщения догружаются только во время активного пользовательского жеста вверх и только когда скрытый сверху буфер уже почти исчерпан; один drag даёт максимум одну маленькую догрузку и не должен визуально сдвигать уже видимое сообщение.
